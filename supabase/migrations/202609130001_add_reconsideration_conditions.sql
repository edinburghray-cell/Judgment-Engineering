...
drop function if exists public.confirm_review_cycle_judgment(uuid);
...
revoke execute on function public.confirm_review_cycle_judgment(uuid, text)
from public, anon;

grant execute on function public.confirm_review_cycle_judgment(uuid, text)
to authenticated;

alter function public.confirm_review_cycle_judgment(uuid, text)
owner to postgres;
