drop function if exists public.get_review_cycle(uuid);

create or replace function public.get_review_cycle(target_review_cycle_id uuid)
returns table(
...
alter function public.get_review_cycle(uuid)
owner to postgres;
